...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (user) {
      ...
      // Realtime listener saat dosen mengakhiri sesi kuliah
      const socket = io();
    ...
    try {
      ...
      if (data.success && data.courses) {
        const formattedCourses: Course[] = data.courses.map((course: any) => ({
          ...course,
          joinUrl:
            course.status === "LIVE" ? `/sesi/${course.id}` : undefined,
        }));
  ...
  const getActionButton = (course: Course) => {
    ...
    return (
      <button
        disabled
        className="px-5 py-2.5 border border-gray-200 w-full sm:w-[192px] h-auto text-gray-400 bg-gray-50 font-medium rounded-xl text-sm whitespace-nowrap transition-colors flex items-center justify-center cursor-not-allowed"
      >
        Belum Dimulai
      </button>
    );
  ...
  // 1. Tab Jadwal: Sesi yang ada di hari saat itu saja
                ...
                <div className="flex flex-col gap-4">
                    ...
                    {isLoading ? (
                      ...
                      <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center">
                        <p className="text-gray-500 text-base">
                          Tidak ada jadwal sesi perkuliahan untuk hari ini.
                        </p>
                      </div>
                    ) : (
                  ...
                  <div className="bg-purple-600 rounded-2xl p-4 lg:p-5 flex items-center gap-3 lg:gap-4">
                    ...
                    <p className="text-white text-sm lg:text-base font-medium">
                      Transkrip & diskusi akan tersedia setelah kamu masuk ke live.
                    </p>
                  </div>
